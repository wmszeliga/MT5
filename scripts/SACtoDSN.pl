...
use TauP::Time;
use Seed::Response;
use lib '/Users/walter/lib/perl5';
use Seismogram::SAC;
...
getTravelTime
{
 ...
 my $taup = TauP::Time->new('/Users/walter/java/3rdParty/TauP-1.1.7');
 $taup->setModel('jb'); # Set the travel time model to the Jefferey's and Bullen model
